...
{
    public partial class QRImageRpt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                using (dc)
                {
                    ...
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptQRImgChkInD.rdlc");
                    ReportViewer1.LocalReport.DataSources.Clear();
                    ReportDataSource rdc = new ReportDataSource("QrImgChkD_DS", cm);
