...
namespace ULABInventory.Web.MVC.Controllers
{
    public class SubCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Priority,Description,CategoryId,Code,PostedBy,PostedIp,PostedDate,UpdatedBy,UpdatedIp,UpdatedDate")] SubCategory subCategory)
        {
