...
namespace ULABInventory.Web.MVC.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,Priority,CategoryId,SubCategoryId,Code,PostedBy,PostedIp,PostedDate,UpdatedBy,UpdatedIp,UpdatedDate")] Item item)
        {
