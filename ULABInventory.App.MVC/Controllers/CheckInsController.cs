...
namespace ULABInventory.App.MVC.Controllers
{
    public class CheckInsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CategoryId,InvoiceNo,SupplierId,PurchaseDate,TotalBillAmount,Comment,PurchaseBy,ReceiptNo,Code,PostedBy,PostedIp,PostedDate,UpdatedBy,UpdatedIp,UpdatedDate")] CheckIn checkIn)
        {
            if (ModelState.IsValid)
            {
